...
class DirectedGraphTest(unittest.TestCase):
    ...
    def test_add_edge(self):
        ...
        self.assertEqual(len(self.graph.edges[0]), 1)
        self.assertEqual(self.graph.edges[0][0], [1, 0])
    ...
    def test_add_multiple_edges(self):
        ...
        self.assertEqual(self.graph.edges, EXPECTED_EDGES[0])
    ...
    def test_remove_three_nodes_with_edges_between(self):
        ...
        self.assertEqual(len(self.graph.edges), 2)
        self.assertEqual(len(self.graph.edges[0]), 1)
        self.assertEqual(self.graph.edges[0], [[1, 0]])
    ...
    def test_set_weight_for_the_edge(self):
        ...
        self.assertEqual(self.graph.edges[1], [])
